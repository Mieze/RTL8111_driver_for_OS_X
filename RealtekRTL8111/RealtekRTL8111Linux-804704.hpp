/* RealtekRTL8111Linux-804704.hpp -- Definitions shared with the linux driver code.
 *
 ...
 *
 * This driver is based on Realtek's r8168 Linux driver (8.047.04).
 */

#ifndef RealtekRTL8111Linux_804704_hpp
#define RealtekRTL8111Linux_804704_hpp
...
void rtl8168_set_dash_other_fun_dev_aspm_clkreq(struct rtl8168_private *tp, u8 aspm_val, u8 clkreq_en, u8 multi_fun_sel_bit);
void rtl8168_set_dash_other_fun_dev_pci_cmd_register(struct rtl8168_private *tp, u8 pci_cmd_reg, u8 multi_fun_sel_bit);
...
void rtl8168_set_dash_other_fun_dev_state_change(struct rtl8168_private *tp,  u8 dev_state, u8 multi_fun_sel_bit);
void rtl8168_disable_ocp_phy_power_saving(struct net_device *dev);

int rtl8168_is_ups_resume(struct net_device *dev);
...
#endif /* RealtekRTL8111Linux_804704_hpp */
